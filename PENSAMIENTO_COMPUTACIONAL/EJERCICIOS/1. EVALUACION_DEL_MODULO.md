...
por cada respuesta correcta de la tabla )
    ...
    programación cuyo propósito es resolver                             programa
    un problema.
    ...
    palabras clave, además de una semántica                             lenguaje de programación
    (interpretación interna).


    La computadora realiza una traducción de
    sus componentes al lenguaje máquina, es
    decir, convierte las instrucciones en                               ejecución de un programa
    ...
    instrucciones en código máquina antes de                            intérprete
    comenzar.
...
1. Menciona al menos 3 tipos de datos que existen: (valor 0.4)
    ...
    Respuesta: enteros, flotantes, booleanos, caracter, cadena o string
